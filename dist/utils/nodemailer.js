...
exports.generatePremiumMembershipEmail = void 0;
...
async function transportMail(formData) {
    try {
        const info = await transporter.sendMail({
            ...
            html: (0, exports.generatePremiumMembershipEmail)(),
        });
        return info;
    }
    catch (error) {
...
const generatePremiumMembershipEmail = function () {
...
exports.generatePremiumMembershipEmail = generatePremiumMembershipEmail;
